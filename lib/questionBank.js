...
// Helper to build a strand-specific drill (10 Q, ~7 min)
function strandDrill({ id, title, grade, strandId, description, weights }) {
  return {
    id, title, grade, description,
    category: 'strand', strandId,
    totalQuestions: Object.values(weights).reduce((a, b) => a + b, 0),
    estMinutes: 7,
    weights,
  };
}
...
export const TESTS = [
  {
    id: 'test-foundations', grade: 'mixed', category: 'full',
  ...
  {
    id: 'test-midterm', grade: 'mixed', category: 'full',
  ...
  {
    id: 'test-final', grade: 'mixed', category: 'full',
    title: 'Final Exam',
  ...
  // ---- Grade 8 full exams ----
  {
    id: 'test-g8-quick', grade: '8', category: 'full',
  ...
  {
    id: 'test-g8-final', grade: '8', category: 'full',
  ...
  // ---- Grade 9 full exams ----
  {
    id: 'test-g9-quick', grade: '9', category: 'full',
  ...
  {
    id: 'test-g9-final', grade: '9', category: 'full',
  ...
  // ================= STRAND DRILLS =================
  // ---- Grade 8 strand drills ----
  strandDrill({
    id: 'test-strand-g8-number', grade: '8', strandId: 'strand-g8-number',
    title: 'Grade 8: Number Drill',
    description: 'Focused 10-question drill on fractions, integers, and powers (Grade 8 Number strand).',
    weights: {
      'g8-frac-thirds':   2, 'g8-frac-fifths': 2, 'g8-frac-twelfths': 1,
      'g8-integer-line':  2, 'g8-integer-wide':1, 'g8-abs-8':          1, 'g8-squares-8':   1,
    },
  }),
  strandDrill({
    id: 'test-strand-g8-algebra', grade: '8', strandId: 'strand-g8-algebra',
    title: 'Grade 8: Algebra & Patterns Drill',
    description: 'Focused 10-question drill on linear patterns and slope/intercept intro concepts.',
    weights: {
      'g8-slope-intro':   2, 'g8-intercept-intro': 2, 'g8-linear-pattern': 2,
      'g8-linear-shrink': 1, 'g8-slope-basic':     1, 'g8-line-match':     1, 'g8-mixed-review': 1,
    },
  }),
  strandDrill({
    id: 'test-strand-g8-data', grade: '8', strandId: 'strand-g8-data',
    title: 'Grade 8: Data Literacy Drill',
    description: 'Focused 10-question drill on percents, probability and proportional reasoning.',
    weights: {
      'g8-percent-basic': 3, 'g8-prob-fraction': 3, 'g8-prob-decimal': 2, 'g8-proportion': 2,
    },
  }),
  strandDrill({
    id: 'test-strand-g8-spatial', grade: '8', strandId: 'strand-g8-spatial',
    title: 'Grade 8: Spatial Sense Drill',
    description: 'Focused 10-question drill on angles and geometric line relationships.',
    weights: {
      'g8-angle-acute': 3, 'g8-angle-obtuse': 2, 'g8-perpendicular-8': 3, 'g8-parallel-8': 2,
    },
  }),
  strandDrill({
    id: 'test-strand-g8-finance', grade: '8', strandId: 'strand-g8-finance',
    title: 'Grade 8: Financial Literacy Drill',
    description: 'Focused 10-question drill on discounts, tax rates and budget modelling.',
    weights: {
      'g8-discount-percent': 4, 'g8-tax-percent': 3, 'g8-budget-linear': 3,
    },
  }),

  // ---- Grade 9 strand drills ----
  strandDrill({
    id: 'test-strand-g9-algebra', grade: '9', strandId: 'strand-algebra',
    title: 'Grade 9: Algebra & Linear Relations Drill',
    description: 'Focused 10-question drill on slope, intercepts, and linear modelling.',
    weights: {
      'node-slope-intercept': 3, 'node-parallel-lines': 2, 'node-perpendicular': 2,
      'node-linear-modelling':2, 'node-negative-slopes':1,
    },
  }),
  strandDrill({
    id: 'test-strand-g9-number', grade: '9', strandId: 'strand-number',
    title: 'Grade 9: Number Sense Drill',
    description: 'Focused 10-question drill on rationals, integers, and powers.',
    weights: {
      'node-rational-ops': 3, 'node-frac-mixed': 2, 'node-numline-integers': 2,
      'node-abs-value':    1, 'node-squares':   1, 'node-cubes':          1,
    },
  }),
  strandDrill({
    id: 'test-strand-g9-data', grade: '9', strandId: 'strand-g9-data',
    title: 'Grade 9: Data Drill',
    description: 'Focused 10-question drill on relative frequency, trend lines and probability.',
    weights: {
      'g9-relative-freq': 3, 'g9-scatter-slope': 2, 'g9-prob-decimal': 2, 'g9-prob-percent': 3,
    },
  }),
  strandDrill({
    id: 'test-strand-g9-geometry', grade: '9', strandId: 'strand-g9-geometry',
    title: 'Grade 9: Geometry & Measurement Drill',
    description: 'Focused 10-question drill on angles and perpendicular/parallel coordinates.',
    weights: {
      'g9-angle-acute': 3, 'g9-angle-reflex': 2, 'g9-perp-lines-9': 3, 'g9-parallel-lines-9': 2,
    },
  }),
  strandDrill({
    id: 'test-strand-g9-finance', grade: '9', strandId: 'strand-g9-finance',
    title: 'Grade 9: Financial Literacy Drill',
    description: 'Focused 10-question drill on simple interest, tax, and savings models.',
    weights: {
      'g9-simple-interest': 4, 'g9-tax-rate': 3, 'g9-savings-linear': 3,
    },
  }),
];
...
export function getTestQuestions(testId) {
  ...
  if (!t) return null;
  // Stable per-test seed base derived from string hash
  let hash = 0;
  for (let i = 0; i < testId.length; i++) hash = ((hash << 5) - hash + testId.charCodeAt(i)) | 0;
  const seedBase = Math.abs(hash) % 100000 + 100;
  const items = [];
